...
public class Main {
        ...
        while (true) { // Бесконечный цикл для отображения меню
            ...
            switch (choice) {
                case 1: // Пункт 1: Ввод исходных данных
                    ...
                    // Поскольку мы ввели новые данные, нужно сбросить результаты работы алгоритма
    ...
    private static void fillMatrix(int[][] matrix, Scanner scanner) {
        System.out.println("Введите элементы матрицы по строкам, разделяя числа пробелами:");
